...
<head>
  ...
  <title>
   SignUp Studio Panel|NasheedHub
  </title>
  ...
  <!-- CSS Files -->
  <link id="pagestyle" href="{{asset('assets/css/soft-ui-dashboard.min.css?v=1.1.0')}}" rel="stylesheet" />
...
<body class="">
    ...
    {{-- <div id="ofBar">
        <div id="ofBar-logo"> 
            <img alt="creative-tim-logo" src="https://s3.amazonaws.com/creativetim_bucket/static-assets/logo-ct-black.png">
        </div>
        <div id="ofBar-content">🔥🔥🔥 <b> Cyber Monday 2024</b>: Get your All-Access Pass to use AI, Development, and UI/UX top tools! <b>85% OFF</b>!  Limited time offer! ✨</div>
        <div id="ofBar-right"><a href="https://www.creative-tim.com/campaign?ref=ct-demos" target="_blank" id="btn-bar">View Offer</a>
            <a id="close-bar">×</a>
        </div>
    </div> --}}
        ...
        <div class="row mt-lg-n10 mt-md-n11 mt-n10">
          <div class="col-xl-4 col-lg-5 col-md-7 mx-auto">
            <div class="card z-index-0">
              ...
              <div class="card-body">
                <form method="POST" role="form text-left" action="{{route('studio.signup_studio')}}">
                  <div class="mb-3">
                    @csrf
                    <input type="text" value="{{old('name')}}" class="form-control @error('name') is-invalid @enderror" placeholder="Name" aria-label="Name" name="name" aria-describedby="email-addon">
                    @error('name')
                    <div class="error text-danger">{{ $message }}</div>
                    @enderror
                </div>
                  <div class="mb-3">
                    <input type="email" value="{{old('email')}}" class="form-control @error('email') is-invalid   @enderror " placeholder="Email" aria-label="Email" name="email" aria-describedby="email-addon">
                  @error('email')
                      <div class="error text-danger">{{$message}}</div>
                  @enderror
                </div>
                  <div class="mb-3">
                    <input type="text" value="{{old('phone')}}" class="form-control @error('phone') is-invalid @enderror" placeholder="Phone number" aria-label="phone" name="phone" aria-describedby="phone-number">
                    @error('phone')
                        <div class="error text-danger">{{$message}}</div>
                    @enderror
                </div>
                  <div class="mb-3">
                    <input type="password" class="form-control @error('password') is-invalid @enderror" placeholder="Password" aria-label="Password" name="password" aria-describedby="password-addon">
                  </div>
                  ...
                  @enderror
                  <div class="mb-3">
                    <input type="text" class="form-control" placeholder="Retype Password" aria-label="Password" name="password_confirmation" aria-describedby="password-addon">
                  </div>
                  <div class="form-check form-check-info text-left">
                    <input class="form-check-input" name="terms" type="checkbox" value="" id="flexCheckDefault" checked>
                  ...
                  <p class="text-sm mt-3 mb-0">Already have an account? <a href="{{route('studio.login')}}" class="text-dark font-weight-bolder">Sign in</a></p>
                </form>
              </div>
            </div>
          </div>
