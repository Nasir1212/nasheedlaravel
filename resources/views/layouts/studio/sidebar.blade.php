<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="{{url('/studio/dashboard')}}" target="_blank">
        <img src="{{asset('assets/img/logos/site_logo.png')}}" class="navbar-brand-img h-100" alt="main_logo">
        <span class="ms-1 font-weight-bold">NasheedHub</span>
      </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link {{isActive('studio.dashboard')}}" href="{{route('studio.dashboard')}}">
        ...
        <li class="nav-item">
          <a class="nav-link {{isActive('studio.my_nasheed')}} " href="{{route('studio.my_nasheed')}}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <span class="nav-link-text ms-1">My Nasheed</span>
          </a>
        </li>

        <li class="nav-item">
          <a class="nav-link {{isActive('studio.profile')}} " href="{{route('studio.profile')}}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        {{-- <li class="nav-item mt-3">
         ...
         --}}
        {{-- <li class="nav-item">
          <a class="nav-link  " href="{{route('studio.login')}}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <a class="nav-link  " href="{{route('studio.logout')}}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
